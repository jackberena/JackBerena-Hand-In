public class Main {
    public static void main(String args[]){
        ...
        */
        ...
        System.out.println((1-8 + 8 / 8 + 9 / 3.0));
        System.out.println((1-8 + 1 + (9/3.0)));
        System.out.println(1-8 + 1 + 3.0);
        System.out.println( -7 + 1 + 3.0);

        //Expression 5
        System.out.println(((14 / 2 + 3) * Math.sin(45) + 2) - Math.pow(Math.sqrt(25), 3));
        System.out.print(((10) * Math.sin(45) + 2) - Math.pow(Math.sqrt(25), 3));
        System.out.print(((10) * Math.sin(45) + 2) - 125);
        System.out.print(((10) * .9509035245341185) - 125);
        System.out.print(-114.49096475465882);
